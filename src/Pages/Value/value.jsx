...
const Value = () => {
  return (
    <div className='h-[220vh] pt-10 bg-value w-full lg:h-[170vh] lg:pt-5 font-poppins text-white'>
        ...
        <div className='flex-col mt-14 space-y-14 flex lg:flex-row justify-around items-center lg:mt-16 flex-wrap lg:space-y-0'>
        ...
        <div className='mt-20 lg:mt-28'>
            ...
            <div className='mt-10 flex flex-col justify-center space-x-0 space-y-10 items-center lg:mt-14 lg:flex-row flex-wrap lg:space-x-16 lg:space-y-0 cursor-pointer'>
